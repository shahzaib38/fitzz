...
//                canvas.drawRect(rect.left - STROKE_WIDTH, rect.top - lineHeight,
//                    rect.left + textWidth + 2 * STROKE_WIDTH, rect.top, labelPaint)
//
//                // Renders the text at the bottom of the box.
//                canvas.drawText(text.text, rect.left, rect.top - STROKE_WIDTH, textPaint)
//

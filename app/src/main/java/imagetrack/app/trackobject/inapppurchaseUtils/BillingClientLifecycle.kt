...
class BillingClientLifecycle private constructor(
    ...
    SkuDetailsResponseListener, PurchasesResponseListener ,AcknowledgePurchaseResponseListener {
    ...
    fun getPurchaseUpdateEventLiveData() : SingleLiveEvent<List<Purchase>>{
        return purchaseUpdateEvent }
    ...
    fun getPurchaseLiveData() :  MutableLiveData<List<Purchase>>{
        return purchases }
   ...
   private  val skusWithSkuDetails = MutableLiveData<Map<String, SkuDetails>>()
    ...
    fun getSkuWithSkuDetailsLiveData():MutableLiveData<Map<String,SkuDetails>>{
...
//
//        println("Query Purchase Response")
//        processPurchases(purchasesList);


        if(purchases==null) {

            processInitialPurchases(purchases)
        }else{
    ...
    override fun onPurchasesUpdated(
        ...
        when (responseCode) {
            ...
            BillingClient.BillingResponseCode.SERVICE_TIMEOUT ->{
                Log.i(TAG, "onPurchasesUpdated: The BillingCLient Service ")
    ...
    private fun processInitialPurchases(purchasesList : List<Purchase>){
        Log.d(TAG, "processPurchases: ${purchasesList?.size} purchase(s)")
        if (isUnchangedPurchaseList(purchasesList)) {
            Log.d(TAG, "processPurchases: Purchase list has not changed")
            return
    ...
    override fun onAcknowledgePurchaseResponse(billingResult: BillingResult) {
      ...
      println("acknowledged" +billingResult.responseCode )

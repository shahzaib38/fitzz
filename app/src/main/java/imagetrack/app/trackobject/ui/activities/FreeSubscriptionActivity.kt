...
import imagetrack.app.trackobject.databinding.FreeSubscriptionDataBinding
...
class FreeSubscriptionActivity   : BaseActivity<MainViewModel, FreeSubscriptionDataBinding>() {
    ...
    private var mMainDataBinding : FreeSubscriptionDataBinding?=null



    override fun getBindingVariable(): Int = BR.viewModel
    override fun getLayoutId(): Int = R.layout.free_subscription_activity
    ...
    private fun setupBottomNavigationBar() {
        ...
        val navGraphIds = listOf(R.navigation.freescan_nav, R.navigation.live_nav)
